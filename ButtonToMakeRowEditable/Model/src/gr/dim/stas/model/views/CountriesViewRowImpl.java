...
import gr.dim.stas.model.entities.CountriesImpl;
...
public class CountriesViewRowImpl extends ViewRowImpl {
    ...
    public CountriesImpl getCountries() {
        return (CountriesImpl)getEntity(0);
    }
    ...
    /**
     * Sets <code>value</code> as attribute value for EDITABLE using the alias name editable.
